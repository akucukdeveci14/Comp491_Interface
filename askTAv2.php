...
if(isset($_POST['requestButton'])){
    ...
    $query2 = "insert into askTA VALUES ('$row[0]', '$selectedCourse')";
...
<div style="border: 1px dashed black; padding: 10px; margin: 3px;"> 
    ...
    <p>You have selected a course to send a request.</p>
    <?php echo "Course you have selected is  $selectedCourse";?> 
    <br><br>
    <input name ="requestButton" type="submit" id="request" name="request" value="Send request to be a TA">
    </form>
    <br>
